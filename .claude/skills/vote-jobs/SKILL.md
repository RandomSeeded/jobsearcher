...
Read all `/data/opportunities/*.yaml` files. Collect those where `vote: null`.
...
### 5. Update files
For each company:
- If the user selected a defined vote option: write that value to `vote:` in `/data/opportunities/<slug>.yaml`
